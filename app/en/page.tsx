        ...
        <StaggerGroup className="flex flex-col md:flex-row items-center gap-8">
          ...
          <Reveal variants={fadeUp} className="md:w-1/2">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/en/about" aria-label="Discover Fanny Samaniego's Journey" className="px-8 py-3 bg-transparent text-brand-blue rounded-full font-semibold border-2 border-brand-blue hover:bg-brand-green hover:text-white transition-all inline-block">
                Discover My Journey
              </Link>
              <Link href="/en/contact?intent=question" aria-label="Start a conversation" className="self-center text-brand-blue underline decoration-2 underline-offset-4 hover:text-brand-green">
        ...
        <StaggerGroup className="text-left max-w-2xl mx-auto">
          <Reveal variants={fadeUp}>
            <ul className="list-disc pl-6 text-brand-body text-base space-y-2">
              ...
              <li>We craft a plan around your strengths and decision style (Human Design available on request), while staying grounded in financial, tax, and legal basics.</li>
            </ul>
          </Reveal>
        </StaggerGroup>
        <Reveal variants={fade}>
          <div className="mt-6 text-center">
            <Link href="/en/contact?intent=hello" className="text-brand-blue underline decoration-2 underline-offset-4 hover:text-brand-green">
            ...
            <Reveal key={c.title} variants={fadeUp}>
              <div className="group bg-white rounded-2xl p-8 shadow-lg border border-brand-gold flex flex-col transition-transform duration-200 will-change-transform hover:-translate-y-1 hover:shadow-xl">
                ...
                <div className="mt-auto space-y-2">
                  <Link href={c.href} aria-label={c.label} className="px-8 py-3 bg-transparent text-brand-green rounded-full font-semibold border-2 border-brand-green hover:bg-brand-green hover:text-white transition-all inline-block">
                    {c.label}
                  </Link>
                  {c.secondary && (
                    <div>
        ...
        <StaggerGroup className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Reveal variants={fadeUp}>
            <div className="group bg-white rounded-2xl p-8 shadow-lg border border-brand-gold flex flex-col transition-transform duration-200 hover:-translate-y-1 hover:shadow-xl">
              ...
              <p className="text-brand-body mb-6">Simple calculators, checklists, and decision helpers to keep things moving—made to match how you actually follow through.</p>
              <ul className="list-disc pl-6 text-brand-body text-sm space-y-1 mb-6">
                <li>Budget & cash-flow worksheet</li>
                <li>Mortgage readiness checklist</li>
                <li>Tax season prep list</li>
              </ul>
              <Link href="/en/tools" aria-label="Browse tools" className="px-8 py-3 bg-transparent text-brand-green rounded-full font-semibold border-2 border-brand-green hover:bg-brand-green hover:text-white transition inline-block">
                Browse Tools
              </Link>
            </div>
          </Reveal>
          ...
          <Reveal variants={fadeUp}>
            <div className="group bg-white rounded-2xl p-8 shadow-lg border border-brand-gold flex flex-col transition-transform duration-200 hover:-translate-y-1 hover:shadow-xl">
              ...
              <p className="text-brand-body mb-6">Short, practical reads on mortgages, money behavior, and tax basics—no jargon, just next steps.</p>
              <ul className="list-disc pl-6 text-brand-body text-sm space-y-1 mb-6">
              ...
              <Link href="/en/resources" aria-label="Read articles" className="px-8 py-3 bg-transparent text-brand-green rounded-full font-semibold border-2 border-brand-green hover:bg-brand-green hover:text-white transition inline-block">
                Read Articles
              </Link>
            </div>
          </Reveal>
      ...
      <RevealPanel className="mt-8" aria-label="Subscribe to financial tips and resources">
        <Reveal variants={fadeUp}>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-brand-body mb-6">Get monthly tips, checklists, and gentle reminders—bilingual and spam-free.</p>
            <Link href="/en/subscribe" aria-label="Go to subscription page" className="px-10 py-3 bg-brand-green text-white rounded-full font-semibold shadow hover:bg-brand-gold hover:text-brand-green border-2 border-brand-blue transition inline-block">
              Subscribe
            </Link>
          </div>
        </Reveal>
