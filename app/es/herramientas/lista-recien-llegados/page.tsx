 ...
 * - Exportar CSV/XLSX, Imprimir, Restablecer
 */
...
export default function Page() {
  ...
  const exportCSV = () => {
    downloadCsv("Checklist_Recien_Llegados", exportRows, { includeDateSuffix: false });
  };

  const exportXLSX = () => {
    downloadXlsx("Checklist_Recien_Llegados", exportRows, {
